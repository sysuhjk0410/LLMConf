...
# Load GSM8K dataset
gsm8k_dataset = load_dataset("openai/gsm8k", "main")["train"]

SHORT_PROMPTS = [example["question"] for example in random.sample(list(gsm8k_dataset), 14)]

LONG_PROMPT_PAIRS = []
selected_examples = random.sample(list(gsm8k_dataset), 20)
