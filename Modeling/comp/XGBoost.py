...
# Columns 1 to 10 are configuration parameters, the rest are 16 evaluation metrics
...
for i, metric in enumerate(metrics):
    ...
    # Get the current evaluation metric as the dependent variable (columns 11 to 26)
